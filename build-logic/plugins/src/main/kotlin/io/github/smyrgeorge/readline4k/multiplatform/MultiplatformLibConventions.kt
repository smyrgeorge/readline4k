package io.github.smyrgeorge.readline4k.multiplatform
        ...
        compilations["main"].cinterops {
            create("ffi") {
                ...
                if (target == "x86_64-pc-windows-gnu") {
                    definitionFile.set(file("src/nativeInterop/cinterop/readline4k-mingwX64.def"))
                } else {
                    definitionFile.set(file("src/nativeInterop/cinterop/readline4k.def"))
                }
